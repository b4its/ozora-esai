 ...
 *    - [v4.1] Eksplisit pin I2C: SDA=GPIO21, SCL=GPIO22
 * ============================================================
 *
 ...
 *    7. WebServer                 (built-in ESP32 Arduino Core)
 * ============================================================
 */
...
// Pin I2C untuk sensor TCS34725 (SDA=GPIO21, SCL=GPIO22)
#define SDA_PIN          21
#define SCL_PIN          22
#define TCS_LED          4
...
<div class="top-nav">
  <div class="brand">
    ...
    <div>
      ...
      <div class="brand-sub">ESP32 IoT Device v4.1</div>
    </div>
  </div>
...
<div class="footer">
  ESP32 IoT Color Sensor &nbsp;&middot;&nbsp; v4.1<br>
...
void setupLocalServer() {
  ...
  localServer.on("/", HTTP_GET, []() {
    ...
    html += "<h2>ESP32 Color Sensor v4.1</h2>";
...
void sendSensorData() {
  ...
  lcdPrintf(0, "C:%03u R:%03u", c, r);
  lcdPrintf(1, "L:%04u %03uK", lux, colorTemp);
...
void setup() {
  ...
  Serial.println(F("\n\n========================================"));
  Serial.println(F("  ESP32 IoT Color Sensor  v4.1"));
  ...
  // Inisialisasi I2C dengan pin eksplisit: SDA=GPIO21, SCL=GPIO22
  // I2C eksplisit
  Wire.begin(SDA_PIN, SCL_PIN);
  Serial.printf("[I2C] Wire.begin(SDA=%d, SCL=%d)\n", SDA_PIN, SCL_PIN);

  // LCD
  lcdPrint("EC Sensor", "Booting...");
  if (detectLCD()) {
    lcd = new LiquidCrystal_I2C(lcdAddr, 16, 2);
    lcd->init();
    lcd->backlight();
    lcdPrint("EC Sensor", "Ready!");

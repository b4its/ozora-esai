...
class ExperimentRoom(models.Model):
    ...
    device_id = models.ForeignKey('IoTDevice', on_delete=models.CASCADE, related_name='experiment_device')
...
class IoTDevice(models.Model):
    ...
    target_status = models.BooleanField(default=True, help_text="True = Mesin ON, False = Mesin OFF")
